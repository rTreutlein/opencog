...
(define rule-basenames
  (list "dv/wip/implication-instantiation.scm"
        "dv/wip/implication-scope-to-implication.scm"
        "dv/wip/equivalence-to-implication.scm"
        "dv/wip/predicate-lambda-evaluation.scm"
        ;;"wip/inversion.scm"
        "dv/wip/implication-implicant-conjunction.scm"
        "dv/wip/and-lambda-factorization-double-implication.scm"
        "dv/wip/deduction.scm"
        "dv/wip/implication-to-implication-scope.scm"
        "dv/wip/equivalence-scope-distribution.scm"
        ;;"wip/and-introduction.scm"
        "dv/wip/joint-introduction.scm"
